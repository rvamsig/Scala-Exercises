...
object FunctionWithOptionParameter extends App {
  ...
  println("\nStep 3: How to call a function which has an Option parameter")
  println(s"""Total cost = ${calculateDonutCost("Glazed Donut", 5, Some("x_coupon"))}""")

  println("\nStep 4: How to assign a default value to an Option parameter")
  ...
  println("\nStep 5: How to call a function which has an Option parameter with a default value")
