...
object FunctionHigherOrderAsParameters extends App {
  ...
  def totalCost(donutType: String)(quantity: Int)(discount: Double): Double = {
    ...
    println(s"calculations for $discount value")

    val totalCost = 2.50 * quantity
    println(s"totalCost for $totalCost value")
    println(s"Function return value = ${totalCost - (totalCost * discount)})")
    totalCost - (totalCost * discount)
  }

  //println( totalCost("MyDonut")(4)(2))
